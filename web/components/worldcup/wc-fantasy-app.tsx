      ...
      {tab === "matches" ? (
        <WcMatchesPanel
          ...
          labels={{
            ...
            playerStatsTitle: t("matchesPlayerStatsTitle"),
            playerStatsLoading: t("matchesPlayerStatsLoading"),
            playerStatsNone: t("matchesPlayerStatsNone"),
            playerStatsNotConfigured: t("matchesPlayerStatsNotConfigured"),
            playerMinutes: t("matchesPlayerMinutes"),
            playerRating: t("matchesPlayerRating"),
            playerGoals: t("matchesPlayerGoals"),
            playerAssists: t("matchesPlayerAssists"),
            playerShots: t("matchesPlayerShots"),
            playerShotsOn: t("matchesPlayerShotsOn"),
            playerKeyPasses: t("matchesPlayerKeyPasses"),
            playerPassAcc: t("matchesPlayerPassAcc"),
            playerTackles: t("matchesPlayerTackles"),
            playerYellow: t("matchesPlayerYellow"),
            playerRed: t("matchesPlayerRed"),
            playerSaves: t("matchesPlayerSaves"),
          }}
        />
      ) : null}
    </div>
