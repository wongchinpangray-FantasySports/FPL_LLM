    ...
    >
      <FplPreseasonPanel
        ...
        labels={{
          ...
          leaderboardHint: t("preseasonLeaderboardHint"),
          clubSummaryTitle: t("preseasonClubSummaryTitle"),
          clubDigestTitle: t("preseasonClubDigestTitle"),
          clubDigestHint: t("preseasonClubDigestHint"),
          formLabel: t("preseasonForm"),
          homeShort: t("preseasonHomeShort"),
          awayShort: t("preseasonAwayShort"),
          scheduledShort: t("preseasonScheduledShort"),
          topScorersShort: t("preseasonTopScorersShort"),
          topAssistsShort: t("preseasonTopAssistsShort"),
