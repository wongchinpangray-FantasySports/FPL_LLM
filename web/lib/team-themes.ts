...
const FPL_THEMES: Record<string, TeamTheme> = {
  ...
  COV: { primary: "#84BCE1", secondary: "#FFFFFF", accent: "#000000", label: "Coventry City" },
  ...
  HUL: { primary: "#E0A922", secondary: "#000000", accent: "#000000", label: "Hull City" },
  IPS: { primary: "#0000FF", secondary: "#FFFFFF", accent: "#FFFFFF", label: "Ipswich Town" },
