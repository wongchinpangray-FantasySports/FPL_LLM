...
/** Official-style EPL club colours by FPL short code. */
const FPL_THEMES: Record<string, TeamTheme> = {
  ...
  HUL: { primary: "#F5971D", secondary: "#000000", accent: "#000000", label: "Hull" },
  IPS: { primary: "#0033A0", secondary: "#FFFFFF", accent: "#FFFFFF", label: "Ipswich" },
  ...
  NEW: { primary: "#241F20", secondary: "#FFFFFF", accent: "#FFFFFF", label: "Newcastle" },
